...
class MyFirstConsumer < Tiki::Torch::Consumer

  consumes 'multiple.events', channel: 'my_one_consumer'
...
lgr.info 'Some stats ...'
lgr.info "MyFirstConsumer : #{MyFirstConsumer.stats.to_hash.to_yaml}"
